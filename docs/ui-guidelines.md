...
The app should feel like a focused leadership operations tool: clear, calm, structured, and fast on mobile.

Avoid marketing-style layouts, public website patterns, decorative hero sections, and unnecessary visual weight. Leaders should be able to open the app and immediately understand what needs to be reported, reviewed, or completed.
...
- Use large enough touch targets for mobile use.
...
- Avoid dense tables on mobile; use lists and detail views.
